          ...
          <div class="md:grid md:grid-cols-12 md:gap-6 items-center">
            ...
            <div class="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right" data-aos-anchor="[data-aos-id-features-home]">
              <div class="md:pr-4 lg:pr-12 xl:pr-16">
                <div class="font-architects-daughter text-xl text-purple-600 mb-2">Give your business a glow up</div>
                <h3 class="h3 mb-3">Reinvente o seu negócio</h3>
                <p class="text-xl text-gray-400 mb-4">Desenvolvemos soluções inteligentes e intuitivas adaptadas às necessidades dos nossos clientes. Com profissionais experientes e metodologias ágeis, superamos com eficiência as expectativas das principais empresas do mundo. Pronto para melhorar o desempenho do seu negócio?</p>
