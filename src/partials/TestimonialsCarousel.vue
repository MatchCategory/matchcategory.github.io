    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="py-12 md:py-20 border-t border-gray-800">
        ...
        <div class="max-w-3xl mx-auto text-center pb-12 md:pb-16" data-aos-id-testimonialcar>
          <h2 class="h2 mb-4" data-aos="fade-up" data-aos-anchor="[data-aos-id-testimonialcar]">Be a <strong class="text-purple-600">Matcher!</strong></h2>
          <p class="text-xl text-gray-400" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-testimonialcar]">Na Match Category, não estamos apenas construindo soluções de tecnologia, estamos moldando o futuro. Se você é apaixonado por desafios, criatividade e inovação, este é o lugar para você!</p>
        </div>
        ...
        <div class="max-w-3xl mx-auto pb-16">
          <ul class="flex flex-col sm:flex-row flex-wrap justify-center items-center text-lg text-gray-400 -mx-3 -my-2">
            <li class="flex items-center mx-3 my-2" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-testimonialcar]">
              ...
              <span>Equilíbrio entre vida profissional</span>
            </li>
            ...
            <li class="flex items-center mx-3 my-2" data-aos="fade-up" data-aos-delay="600" data-aos-anchor="[data-aos-id-testimonialcar]">
              ...
              <span>4 semanas de férias remuneradas</span>
            </li>
